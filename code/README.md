...
The `KGE_models/` folder contains the implementation for the KGE models which can support link prediction and store recommendation.

The `traditional_ridership_prediction/` folder contains the implementation for the traditional knowledge-enhanced ridership prediction.  

The `LLM_ridership_prediction/` folder contains the implementation for the LLM-based knowledge-enhanced ridership prediction and the prompts.  
