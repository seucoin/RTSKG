...
def micro_f1(y_pred, y_true):
    ...
    y_pred = (y_pred.flatten() >= 0.69).astype(int)
...
def macro_f1(y_pred, y_true):
    ...
    y_true = y_true.cpu().detach().numpy()
    # print('before')
    # print('beforeY_pred',y_pred,'predSize',y_pred.shape)
    # print('beforeY_true',y_true)

    y_pred = (y_pred.flatten() >= 0.69).astype(int)
    y_true = (y_true.flatten() >= 0.4).astype(int)

    # print('afterY_pred',y_pred, 'afterpredSize',y_pred.shape)
    # print('afterY_true',y_true)
